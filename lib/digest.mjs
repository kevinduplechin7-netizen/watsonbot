...
const BUCKETS = [
  ...
  // life topics
    { name: "personality_systems", keys: ["enneagram","type 1","type 2","type 3","type 4","type 5","type 6","type 7","type 8","type 9","wing","wings","tritype","instinct","instincts","sx","sp","so","mbti","myers briggs","myers-briggs","intj","infj","istj","isfj","intp","infp","istp","isfp","entj","enfj","estj","esfj","entp","enfp","estp","esfp","big five","big-five","ocean","openness","conscientiousness","extraversion","agreeableness","neuroticism","temperament","attachment style","love languages","love language"] },
{ name: "relationships", keys: ["relationship","relationships","dating","marriage","married","spouse","husband","wife","partner","boyfriend","girlfriend","fiancé","fiance","fiancée","engagement","breakup","divorce","argument","apology","forgiveness","conflict","communication","boundaries","boundary","counseling","therapist","therapy","intimacy","trust","respect","parenting","co-parenting","family","family dynamics"] },
  ...
  { name: "places", keys: ["texas","tx","dfw","dallas","fort worth","fw","austin","houston","san antonio","washington dc","dc","d.c.","capitol","ohio","cleveland","columbus","cincinnati"] },
    { name: "history", keys: ["history","historical","ancient","medieval","renaissance","empire","roman","greece","greek","persia","persian","ottoman","byzantine","revolution","civil war","world war","ww1","ww2","cold war","vietnam","iraq","afghanistan","timeline","chronology","primary source","archives","biography","memoir"] },
  { name: "group_history", keys: ["childhood","childhood friends","old friends","long lost","long-lost","reunion","remember when","back in the day","way back","years ago","when we were kids","growing up","high school","middle school","class of","old days","the old crew","back home","hometown","we go back","we go way back","throwback","nostalgia"] },
{ name: "memories", keys: ["remember","memories","memory","nostalgia","back in the day","when we were kids","childhood","old friends","childhood friends","high school","growing up"] },
    ...
    { name: "ufo_paranormal", keys: ["ufo","ufos","uap","uaps","aliens","alien","abduction","abducted","extraterrestrial","et","grey","grays","roswell","area 51","area51","disclosure","whistleblower","tic tac","tictac","orbs","orb","triangle lights","craft","phenomenon","paranormal","ghost","ghosts","haunted","haunting","poltergeist","demon","demons","angel","angels","apparition","apparitions","spirit","spirits","occult","psychic","remote viewing","skinwalker"] },
  { name: "conspiracy", keys: ["conspiracy","psyop","false flag","coverup","cover-up","deep state","black budget","classified","leak","operation","narrative","propaganda","controlled","manufactured"] },
